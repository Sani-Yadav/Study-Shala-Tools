...
from .views import create_id_card, id_card_view, update_id_card, bulk_upload_id_cards, delete_id_card, idcard_management

app_name = 'idcard'  # Yeh line add karo

urlpatterns = [
    path('', idcard_management, name='idcard_management'),
